    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-12 gap-6 ">
                ...
                @can('view government daily reports')
                    <a href="{{ route('reports.opd.reportDailyOpd') }}"
                        class="transform  hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-white">
                        <div class="p-5">
                            <div class="grid grid-cols-3 gap-1">
                                <div class="col-span-2">
                ...
                @can('view govt user wise reports')
                    <a href="{{ route('reports.ipd.reportDailyUserWiseGovt') }}"
                        class="transform  hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-white">
                        <div class="p-5">
                            <div class="grid grid-cols-3 gap-1">
                                <div class="col-span-2">
                                ...
                                <div class="col-span-1 flex items-center justify-end">
                                    <img src="{{ url('images/reports.png') }}" alt="govt user wise report" class="h-12 w-12">
                                </div>
                            </div>
                        </div>
                    </a>
                ...
                @can('view department wise audit reports')
                    <a href="{{ route('reports.misc.department-wise-audit') }}"
                        class="transform  hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-white">
                        <div class="p-5">
                            <div class="grid grid-cols-3 gap-1">
                                <div class="col-span-2">
